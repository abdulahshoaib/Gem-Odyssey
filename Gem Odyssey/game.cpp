...
void BlastDestroyer(int Board[][8], int row, int col)  //has been extended to destroy all destroyers and special gems in the premise of destroyer
{
	...
	for (int i = 0; i < 8; i++) //makes colom -1
	{
		...
		else if (Board[i][col] > 9 && Board[i][col] < 20)
		{
			...
			for (int cleartop = i; cleartop >= 0; cleartop--) //to make -1 for good +
...
{
	system("CLS");
	RenderWindow window(VideoMode(1920, 1080), "Play Game", Style::Default); //Creating a new window
	int r = 0;
	int c = 0;
	//Adding font 
	Font font;
	if (!font.loadFromFile("externals/Valorant Font.ttf")) {
	...
	Texture black = loadTexture("externals/black.png");
	Texture gem0 = loadTexture("externals/candy0.png");
	Texture gem1 = loadTexture("externals/candy1.png");
	Texture gem2 = loadTexture("externals/candy2.png");
	Texture gem3 = loadTexture("externals/candy3.png");
	Texture gem4 = loadTexture("externals/candy4.png");
	Texture gem10 = loadTexture("externals/candy10.png");
	Texture gem11 = loadTexture("externals/candy11.png");
	Texture gem12 = loadTexture("externals/candy12.png");
	Texture gem13 = loadTexture("externals/candy13.png");
	Texture gem14 = loadTexture("externals/candy14.png");
	Texture gem20 = loadTexture("externals/candy20.png");
	Texture gem21 = loadTexture("externals/candy21.png");
	Texture gem22 = loadTexture("externals/candy22.png");
	Texture gem23 = loadTexture("externals/candy23.png");
	Texture gem24 = loadTexture("externals/candy24.png");

	srand(static_cast<unsigned int>(time(nullptr)));

	// Create an 8x8 matrix and fill it with random numbers
	...
	while (window.isOpen() && secondsRemaining)
	{
		...
		for (int i = 0; i < matrixSize; ++i)
		{
			for (int j = 0; j < matrixSize; ++j)
			{
				...
				Gem10.setPosition(600 + x, 100 + y);
				Gem11.setPosition(600 + x, 100 + y);
				Gem12.setPosition(600 + x, 100 + y);
				Gem13.setPosition(600 + x, 100 + y);
				Gem14.setPosition(600 + x, 100 + y);
				Gem20.setPosition(600 + x, 100 + y);
				Gem21.setPosition(600 + x, 100 + y);
				Gem22.setPosition(600 + x, 100 + y);
				Gem23.setPosition(600 + x, 100 + y);
				Gem24.setPosition(600 + x, 100 + y);
				...
				{
				case 0:
					gem0.loadFromFile("externals/candy0.png");
					Gem0.setScale(0.23, 0.23);
					window.draw(Gem0);
					break;

				case 1:
					gem1.loadFromFile("externals/candy1.png");
					Gem1.setScale(0.23, 0.23);
					window.draw(Gem1);
					break;

				case 2:
					gem2.loadFromFile("externals/candy2.png");
					Gem2.setScale(0.23, 0.23);
					window.draw(Gem2);
					break;

				case 3:
					gem3.loadFromFile("externals/candy3.png");
					Gem3.setScale(0.23, 0.23);
					window.draw(Gem3);
					break;

				case 4:
					gem4.loadFromFile("externals/candy4.png");
					Gem4.setScale(0.23, 0.23);
					window.draw(Gem4);
					break;
				case 10:
					gem10.loadFromFile("externals/candy10.png");
					Gem10.setScale(0.21, 0.21);
					window.draw(Gem10);
					break;

				case 11:
					gem11.loadFromFile("externals/candy11.png");
					Gem10.setScale(0.21, 0.21);
					window.draw(Gem11);
					break;
				case 12:
					gem12.loadFromFile("externals/candy12.png");
					Gem12.setScale(0.21, 0.21);
					window.draw(Gem12);
					break;

				case 13:
					gem13.loadFromFile("externals/candy13.png");
					Gem13.setScale(0.21, 0.21);
					window.draw(Gem13);
					break;
				case 14:
					gem14.loadFromFile("externals/candy14.png");
					Gem14.setScale(0.21, 0.21);
					window.draw(Gem14);
					break;
				case 20:
					gem20.loadFromFile("externals/candy20.png");
					Gem20.setScale(0.20, 0.20);
					window.draw(Gem20);
					break;

				case 21:
					gem21.loadFromFile("externals/candy21.png");
					Gem20.setScale(0.20, 0.20);
					window.draw(Gem21);
					break;
				case 22:
					gem22.loadFromFile("externals/candy22.png");
					Gem22.setScale(0.20, 0.20);
					window.draw(Gem22);
					break;

				case 23:
					gem23.loadFromFile("externals/candy23.png");
					Gem23.setScale(0.20, 0.20);
					window.draw(Gem23);
					break;
				case 24:
					gem24.loadFromFile("externals/candy24.png");
					Gem24.setScale(0.20, 0.20);
					window.draw(Gem24);
					break;
...
void infoMenu()
{
	...
	if (!backgroundTexture.loadFromFile("externals/credbg.jpg"))
	{
	...
	while (window.isOpen())
	{
		...
		window.draw(p3);
		window.draw(back);
		//Add window.draw functions here
...
void credMenu()
{
	...
	Text p1 = createButton("ALI YOUSAF | 23L - 0737", font, 120, Vector2f(150, 200), Color::Black);
	Text p2 = createButton("HARIS FAYYAZ | 23L - 0767", font, 120, Vector2f(150, 600), Color::Black);
	Text back = createButton("ESC to Exit ", font, 50, Vector2f(20, 900), Color::Black);
...
int main() {
	...
	RenderWindow window(VideoMode(1920, 1080), "Game", Style::Default);
	...
	Text playButton = createButton("Play", font, 60, Vector2f(800, 300), Color::Black);
	Text creditButton = createButton("Credit", font, 60, Vector2f(780, 420), Color::Black);
	Text infoButton = createButton("How to Play", font, 60, Vector2f(700, 540), Color::Black);
	Text exitButton = createButton("Exit", font, 60, Vector2f(820, 660), Color::Black);
	Text arrow = createButton("--------------", font, 50, Vector2f(730, 350), Color::Black);

	// Load and set up the background image
	Texture backgroundTexture;
	if (!backgroundTexture.loadFromFile("externals/gamebg.jpg"))
	{
		cerr << "Error loading background image" << endl;
		return 0;
	}
